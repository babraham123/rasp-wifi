...
NAME="Rasp SocketIO Server"
NODE_BIN_DIR="/usr/local/bin"
NODE_PATH="/usr/local/lib/node_modules"
APPLICATION_PATH="/home/pi/raspsocketio/socketio_server.js"
APPLICATION_PARAMS="--port 8002 --debug"
PIDFILE="/var/run/rasp-socketio.pid"
LOGFILE="/var/log/rasp-socketio.log"
MIN_UPTIME="5000"
SPIN_SLEEP_TIME="2000"
...
start() {
    ...
    forever \
      ...
      start $APPLICATION_PATH $APPLICATION_PARAMS 2>&1 > /dev/null &
    RETVAL=$?
}
